...
\begin{document}
\receiveddate{1 March, 2026}
\reviseddate{1 March, 2026}
\accepteddate{1 March, 2026}
\publisheddate{1 March, 2026}
\currentdate{1 March, 2026}
\doiinfo{}
...
detalla la arquitectura del sistema; la Secci\'on~III describe el algoritmo de adaptabilidad;
la Secci\'on~IV presenta la metodolog\'ia de evaluaci\'on; y la Secci\'on~V expone las
conclusiones.
...
\begin{figure}
\centerline{\includegraphics[width=3.5in]{example-image-a}}
...
El autor agradece a la Universidad Distrital Francisco Jos\'e de Caldas
y al programa de Ingenier\'ia de Sistemas por el apoyo acad\'emico brindado
...
{JUAN CARLOS QUINTERO RUBIANO} es estudiante de Ingenier\'ia de Sistemas
en la Universidad Distrital Francisco Jos\'e de Caldas (c\'odigo 20232020172),
Bogot\'a, Colombia. Sus intereses de investigaci\'on incluyen la inteligencia
artificial generativa, los sistemas educativos adaptativos, los juegos serios
y la generaci\'on procedural de contenido. LUCID es su propuesta de grado en
el \'area de fundamentos de redes y sistemas distribuidos.
